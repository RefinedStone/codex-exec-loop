...
- Treat `docs/plan/14-product-elevation-blueprint.md`, `docs/plan/15-ux-flow-rearchitecture.md`, `docs/plan/16-planning-and-automation-evolution.md`, and `docs/plan/17-structure-and-architecture-debt-map.md` as the long-term product roadmap for this workspace.
...
- Prefer active directions in this order unless current code state clearly blocks it:
  `operator-state-language`, `queue-and-automation-trust`, `planning-authoring-ergonomics`, `session-continuity-and-recovery`, `architecture-boundaries`, `validation-and-release-confidence`.
