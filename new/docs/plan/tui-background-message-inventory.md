...
| `PostTurnEvaluated` | post-turn execution effect | stale guard, then `ConversationRuntimeEvent::PostTurnEvaluated` reducer | planning worker panel projection, runtime snapshot projection, queued auto prompt effect |
