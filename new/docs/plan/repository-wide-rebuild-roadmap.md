...
| --- | --- | --- | --- |
| P0 | `PAR-00` | ready | parallel regression contract 고정 |
| P0 | `PAR-01` | blocked | parallel domain decision seed |
| P0 | `PAR-02` | blocked | parallel application runtime facade |
| P0 | `PAR-03` | blocked | parallel TUI controller split |
| P0 | `PAR-04` | blocked | parallel worker event path |
