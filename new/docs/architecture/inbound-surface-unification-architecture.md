...
| --- | --- | --- | --- |
| TUI planning shell/overlay | `PlanningServices`, planning controllers, status projection | UI-only overlay/editor state와 application service 호출 분리 | planning command request DTO를 admin/CLI와 같은 이름으로 정렬 |
