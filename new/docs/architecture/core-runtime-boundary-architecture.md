...
| planning runtime projection | Ready conversation cache + core projection | core app state 또는 application projection | 여러 surface가 같은 planning 상태를 본다. |
