...
| post-turn continuation/evaluation | TUI post-turn path + core completion re-entry | core runtime/application service | turn completion 이후 정책은 화면과 독립적이다. |
