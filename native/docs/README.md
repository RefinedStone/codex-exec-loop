...
4. If you are working on the main remaining product problem, read [plan/10-inline-scrollback-shell.md](plan/10-inline-scrollback-shell.md) next.
...
- [plan/10-inline-scrollback-shell.md](plan/10-inline-scrollback-shell.md): primary remaining product workstream for making inline mode scrollback-first and flow-oriented
