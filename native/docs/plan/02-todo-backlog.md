...
## Open Change Buckets
- platform validation
  - the validation matrix, capture helpers, checked-in record directory, summary helper, and packaging docs are landed, but real macOS and Windows runs still need to be recorded
