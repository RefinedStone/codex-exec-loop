...
pub(crate) struct PlanningFollowupSurfaceProjection {
    pub(crate) current_state_line: String,
    pub(crate) cause_line: String,
    pub(crate) next_action_line: String,
...
pub(crate) fn build_planning_followup_surface_projection(
    ...
    PlanningFollowupSurfaceProjection {
        current_state_line: followup_projection.current_state_line,
        cause_line: followup_projection.cause_line,
        next_action_line: followup_projection.next_action_line,
        ...
        queue_framing_lines: build_queue_framing_lines(conversation, max_detail_len),
    }
}
