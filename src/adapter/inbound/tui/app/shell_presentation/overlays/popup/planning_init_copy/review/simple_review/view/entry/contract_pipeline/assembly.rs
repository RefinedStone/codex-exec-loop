...
// 실제 final assembly는 view/assembly module의 책임이다. pipeline assembly는 entry 계층에서 그 final
...
// `build_simple_review_overlay_view_from_contract`는 contract pipeline의 두 번째 단계다. contract가 만들어진
