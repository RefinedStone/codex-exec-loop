...
use crate::domain::parallel_mode::{
    ...
    ParallelModeCapabilitySnapshot, ParallelModeCapabilityState, ParallelModePoolBoardSnapshot,
...
use self::readiness::{
    blocked_prerequisite_capability, command_succeeds, derive_readiness, detect_git_repo_root,
    inspect_akra_branch, inspect_authority_store, inspect_gh_auth, inspect_gh_binary,
    inspect_git_worktree, inspect_planning, inspect_push_remote, run_command,
};
use self::session_detail::{
    ReportedCompleteSessionDetailUpdate, build_assigned_session_detail,
    default_ledger_refresh_outcome, default_validation_summary,
    format_elapsed_label_from_timestamp, lease_session_key, load_agent_session_detail_records,
    record_assigned_session_detail, record_cleaned_session_detail,
    record_cleanup_pending_session_detail, record_commit_ready_session_detail,
    record_distributor_failed_session_detail, record_failed_start_session_detail,
    record_integrating_session_detail, record_ledger_refreshing_session_detail,
    record_merge_pending_session_detail, record_merge_queued_session_detail,
    record_official_completion_failed_session_detail, record_pr_pending_session_detail,
    record_pushing_session_detail, record_reported_complete_session_detail,
