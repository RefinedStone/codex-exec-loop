...
const BUILTIN_TEMPLATE_NEXT_TASK: &str = r#"자동 후속 {auto_turn}/{max_auto_turns} 입니다.
...
직전 답변:
{last_message}"#;
const BUILTIN_TEMPLATE_PLAN_QUEUE: &str = r#"자동 후속 {auto_turn}/{max_auto_turns} 입니다.
...
직전 답변:
{last_message}"#;
const BUILTIN_TEMPLATE_BUGFIX: &str = r#"자동 후속 {auto_turn}/{max_auto_turns} 입니다.
...
직전 답변:
{last_message}"#;
const BUILTIN_TEMPLATE_DOCS: &str = r#"자동 후속 {auto_turn}/{max_auto_turns} 입니다.
