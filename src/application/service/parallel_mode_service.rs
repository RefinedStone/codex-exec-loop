...
#[path = "parallel_mode_distributor_service.rs"]
mod parallel_mode_distributor_service;

use parallel_mode_distributor_service::{
    ParallelModeDistributorService, load_distributor_queue_records, selected_runtime_session_detail,
};
...
impl ParallelModeService {
    ...
    pub fn build_supervisor_snapshot(
        ...
        ParallelModeSupervisorSnapshot::new(
            ...
            self.distributor_service.build_snapshot(
                workspace_dir,
                mode_enabled,
                readiness_snapshot,
            ),
