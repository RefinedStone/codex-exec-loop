...
- diagnostics, sessions, templates, planning, directions maintenance, and queue render as in-shell inspection surfaces
- inline is the only shipped frontend path

## Commands And Keys

- inline shell commands: `:diag`, `:sessions`, `:templates`, `:queue`, `:directions`, `:stop`, `:planning`, `:new`, `:help`
