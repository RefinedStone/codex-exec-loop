...
- Session overlay presentation must consume one owned screen model per draw; filtering, paging, and
  selection repair run once, and repeated redraws must perform no session-catalog I/O.
